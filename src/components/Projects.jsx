    ...
    <section id="projects" className="projects">
      ...
      <div className="project-list">
        <div className="project-card">
          ...
          <a href="https://www.figma.com/design/6ufxES81TTQzzaGs6hEjSp/Website-Wirefram?node-id=1-197&node-type=canvas&t=KSO9jGGYxXpxQN0Z-0" target="_blank" rel="noopener noreferrer">View Project</a>
        </div>
        <div className="project-card">
          ...
          <a href="https://awesomesisir.onrender.com" target="_blank" rel="noopener noreferrer">View Project</a>
        </div>
      </div>
    </section>
  );
